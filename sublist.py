...
def sum_sorted(ints, target, run_ints, i=0):
  """This version of my function takes advantage of the integers being
     sorted.  This allows optimization by not pursuing chains where 
     the sum of the remaining integers in the sorted list plus the 
     current partial sum is less than the targt value.
